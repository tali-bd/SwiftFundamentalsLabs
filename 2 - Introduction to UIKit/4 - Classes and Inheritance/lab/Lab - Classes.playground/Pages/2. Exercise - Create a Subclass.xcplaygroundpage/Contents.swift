 ...
 */
print("The reason this will not compile is because falcon is an object of the Class: Spaceship, while the \"weapon\" property belongs to a subclass of the Spaceship class called Fighter. Fighter inherits properties from its superclass: Spaceship, but not the other way around. \nfalcon will never be able to access the \"weapon\" property because it does not exist to the Fighter class")
