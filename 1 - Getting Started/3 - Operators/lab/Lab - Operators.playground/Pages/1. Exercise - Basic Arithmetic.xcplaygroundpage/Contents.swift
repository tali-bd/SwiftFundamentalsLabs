 ...
 */
print("My expectation of int division of 10 divided by 3: The result would be 3 because the int type rounds down in this case")
...
print("This differs from using integer division because it includes the decimal point. Int only works with whole numbers")
/*:
